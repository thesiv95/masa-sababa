        ...
        return (
            <div>
                ...
                <div className="main_steps container">
                    <Step number='1' title={stepsTitles[0]} description={stepsDesc[0]} img='img/steps/clip-bad-gateaway.png'/>
                    <Step number='2' title={stepsTitles[1]} description={stepsDesc[1]} img='img/steps/clip-payment.png'/>
                    <Step number='3' title={stepsTitles[2]} description={stepsDesc[2]} img='img/steps/clip-welcome.png'/>
                    <Step number='4' title={stepsTitles[3]} description={stepsDesc[3]} img='img/steps/clip.png'/>
                    <Step number='5' title={stepsTitles[4]} description={stepsDesc[4]} img='img/steps/clip-sign-up.png'/>
                    <Step number='6' title={stepsTitles[5]} description={stepsDesc[5]} img='img/steps/clip-travel.png'/>
                    <Step number='7' title={stepsTitles[6]} description={stepsDesc[6]} img='img/steps/clip-no-messages.png'/>
                    <Step number='8' title={stepsTitles[7]} description={stepsDesc[7]} img='img/steps/clip-list-is-empty.png'/>
                    <Step number='9' title={stepsTitles[8]} description={stepsDesc[8]} img='img/steps/clip-waiting.png'/>
                </div>
                {/* 3 */}
