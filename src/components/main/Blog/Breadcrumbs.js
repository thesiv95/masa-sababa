    ...
    render() {
        return (
            <div className="main_breadcrumbs">
                <a href="#prev" className="main_breadcrumbs-nav direction-page">{Lang.ru.breadcrumbs_previous}</a>
                ...
                <a href="#next" className="main_breadcrumbs-nav direction-page">{Lang.ru.breadcrumbs_next}</a>
            </div>
        )
    }
}
